      ...
      <>
          ...
          <motion.div
              ...
              <div className="absolute text-7xl top-[25%] left-[38%] z-30 text-white md:left[35%] group-hover:text-red-400">
                  ...
                  <img src="https://zephyrcreates.com/wp-content/uploads/2019/06/music-covers-WEB-zephyr-02.jpg" alt="Not Found" className="absolute top-0 left-0 w-full h-full rounded-xl" />
